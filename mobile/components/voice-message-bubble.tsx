...
function WeChatVoiceWave({
  ...
  return (
    <Svg width={VOICE_WAVE_WIDTH} height={VOICE_WAVE_HEIGHT} viewBox="0 0 31.83318 24">
      <G>
        <Path
          d="M6 12 L8.511328 9.834959 A3.31574562 3.31574562 0 0 1 8.511328 14.165041 Z"
          fill={color}
        />
        {level >= 2 && (
          <Path
            d="M12.881395 6.067479 A9.08561481 9.08561481 0 0 1 12.881395 17.932521 L10.570827 15.940556 A6.03493506 6.03493506 0 0 0 10.570827 8.059444 Z"
            fill={color}
          />
        )}
        {level >= 3 && (
