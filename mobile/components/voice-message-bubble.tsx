...
function WeChatVoiceWave({
  ...
  return (
    <Svg width={VOICE_WAVE_WIDTH} height={VOICE_WAVE_HEIGHT} viewBox="0 0 31.83318 24">
      <G>
        <Path
          d="M6 12 L9.202317 9.23925 A4.228069844 4.228069844 0 0 1 9.202317 14.76075 Z"
          fill={color}
        />
        {level >= 2 && (
          <Path
            d="M13.984284 5.116667 A10.541776922 10.541776922 0 0 1 13.984284 18.883333 L11.673716 16.891368 A7.491097172 7.491097172 0 0 0 11.673716 7.108632 Z"
            fill={color}
          />
        )}
        {level >= 3 && (
          <Path
            d="M17.251462 2.3 A14.855484 14.855484 0 0 1 17.251462 21.7 L16.455683 21.013951 A13.80480425 13.80480425 0 0 0 16.455683 2.986049 Z"
            fill={color}
          />
        )}
      </G>
